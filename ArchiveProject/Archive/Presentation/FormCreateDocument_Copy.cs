...
namespace Archive
{
    public partial class FormCreateDocument_Copy : Form
    {
        ...
        public FormCreateDocument_Copy(int mainCategoryId)
        {
            InitializeComponent();
        ...
        public FormCreateDocument_Copy(IDocumentService documentService, IContentService contentService, IFileService fileService, ICategoryService categoryService)
        {
            this.SuspendLayout();
            InitializeComponent();
            this.ResumeLayout();
        ...
        private void FormCreateDocumentSpeach_Load(object sender, EventArgs e)
        {
            ...
            ComboBoxFileType_Sound.DataSource = _fileTypes;
            ComboBoxFileType_Sound.DisplayMember = "FileTypeTitle";
            ComboBoxFileType_Sound.ValueMember = "FileTypeId";
            ComboBoxFileType_Sound.Text = "انتخاب کنید";
        ...
        {
            if (_isFirst) return;
            _fileTypeId = ((FileType)ComboBoxFileType_Sound.SelectedItem).FileTypeId;
            _fileTypeTitle = ((FileType)ComboBoxFileType_Sound.SelectedItem).FileTypeTitle;
        ...
        private void radNavigationView1_SelectedPageChanged(object sender, EventArgs e)
        {
            ...
            _contentType = new ContentType { ContentTypeTitle = contentTypeTitle, ContentTypeId = contentTypeId };
        }
        ...
        {
            if (_isFirst) return;
            _resourceId = ((Resource)ComboBoxResource_Sound.SelectedItem).ResourceId;
            _resourceTitle = ((Resource)ComboBoxResource_Sound.SelectedItem).ResourceTitle;
        }
